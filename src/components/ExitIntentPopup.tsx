          ...
          <div className="p-8 md:p-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">
                Wait! The Steam Playtest is open
              </span>
            </h2>

            {/* Description */}
            <p className="text-lg md:text-xl text-slate-200 mb-2">
              Request access on Steam — <strong className="text-amber-300">100 testers approved daily</strong>
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8 text-sm">
              ...
              <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                <div className="text-2xl mb-1">🚀</div>
                <p className="text-slate-300">Early Access Priority</p>
              </div>
            </div>
            ...
            <p className="text-xs text-slate-400">
              It&apos;s 100% free • Wishlist while you&apos;re there to be ready for Early Access
            </p>
          </div>
        </div>
      </div>
